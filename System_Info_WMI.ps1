...
$Workstations += [PScustomobject]@{Name=$comp.name; Version = $bios.smbiosbiosversion; IMEversion=$IMEversion.driverversion; IMEFirmware=$IMEFirmware.'ME Version' ;Model=$comp.model}
